...
templateString = 'The {symbol} yVault version {version} at {address} has a currently a Total Value Locked (TVL) of {tvl[tvl]}, and an annual percentage yield (APY) of {apy[net_apy]}'
output = [] 
