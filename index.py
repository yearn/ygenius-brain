...
def ask():
  ...
  prefix = '######## Below is chat history with anon (just for context)\n\n' + history + '\n\n######## Below is current interaction with anon (as a GPT-powered assistant bot made to help users learn about Yearn Finance). Don\'t comment about answer provided.\n\n'
